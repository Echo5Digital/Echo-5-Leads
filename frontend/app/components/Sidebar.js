...
export default function Sidebar() {
  ...
  const { selectedTenant, switchTenant, tenants, setTenants } = useTenant();  const {
    user,
    isAuthenticated,
    loading: authLoading,
    logout,
  ...
  const getMenuItems = () => {
    const allItems = [
      ...
      },
      {
        ...
        roles: ['super_admin', 'client_admin', 'member', 'manager', 'staff', 'ceo', 'cfo']
      },
      {
        name: 'Add New Lead',
        href: '/leads/new',
      ...
      },
      {
        ...
        roles: ['super_admin', 'client_admin', 'ceo', 'cfo', 'manager']
      },
      {
        name: 'Settings',
        href: '/settings',
        ...
        roles: ['super_admin', 'client_admin', 'manager', 'member', 'staff']
      }
    ];
      ...
      <div className="absolute bottom-0 left-0 right-0 border-t border-gray-800">
        ...
        <div className="p-4">
          <div className="text-xs text-gray-400">
            {(isClientAdmin() || isMember() || isExecutive()) && user?.tenant && (
              <>
